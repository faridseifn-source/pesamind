/**
 * Contract for the prepaid card program manager (e.g. Marqeta/Galileo/i2c-style,
 * or a sponsor bank's own issuing platform). Once real, this provider is the
 * source of truth for balance and authorizations — our DB's `Card.balance`
 * becomes a cache updated via webhook, not the ledger of record.
 *
...
class CardIssuingProvider {
  ...
  async debit(externalCardId, params) {
