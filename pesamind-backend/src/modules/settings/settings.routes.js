...
const PUBLIC_KEYS = ["qr_test_samples_enabled", "qr_manual_payload_paste_enabled", "qr_step_up_threshold", "biometric_login_enabled", "push_notifications_enabled", "household_max_members"];
