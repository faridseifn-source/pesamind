...
const PUBLIC_KEYS = ["qr_test_samples_enabled", "qr_manual_payload_paste_enabled", "qr_step_up_threshold", "biometric_login_enabled", "push_notifications_enabled", "receipt_ocr_enabled", "pfm_export_enabled", "multi_currency_enabled", "available_currencies", "verification_method", "household_max_members"];
