...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const card = await prisma.virtualCard.create({
      data: { walletId, ownerId: req.userId, holderId: holderUserId, type: "parent_linked", label: label || null, last4: genLast4(), expiry: "09/29" },
    });
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const card = await prisma.virtualCard.create({
      data: { walletId: personalMembership.walletId, ownerId: req.userId, holderId: req.userId, type: "independent", label: label || null, last4: genLast4(), expiry: "09/29" },
    });
