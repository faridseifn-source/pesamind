...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (parsed.amountFixed && transfersActuallyEnabled) {
      ...
      if (coverage.covered) {
        fee = { pesaMindFeeRule: coverage.wouldBeRule, coveredMessage: coverage.reason, partnerFee: partnerFeePreview, transfersEnabled: transfersActuallyEnabled };
      } else {
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const fee = coverage.covered
      ? { pesaMindFeeRule: coverage.wouldBeRule, coveredMessage: coverage.reason, partnerFee: partnerFeePreview, transfersEnabled: transfersActuallyEnabled }
