...
function getFeeBreakdown(fee, amount) {
  if (!fee) return { pesaMindFee: 0, partnerFee: 0, tax: 0, totalFee: 0, transfersEnabled: true };
  if (fee.totalFee !== undefined) {
    return { pesaMindFee: fee.pesaMindFee || 0, partnerFee: fee.partnerFee || 0, tax: fee.tax || 0, totalFee: fee.totalFee || 0, transfersEnabled: fee.transfersEnabled !== false };
  }
  ...
  return { pesaMindFee, partnerFee, tax: 0, totalFee: pesaMindFee + partnerFee, transfersEnabled: fee.transfersEnabled !== false };
}
