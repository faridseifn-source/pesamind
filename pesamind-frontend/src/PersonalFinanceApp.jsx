      ...
      >
        {cards.map((c) => (
          <div
            ...
            className="shrink-0 rounded-[22px] p-4 cursor-pointer"
            style={{
              width: "calc(100% - 40px)",
              height: 172,
          ...
          >
            ...
            <p className="text-[10.5px] mb-3 truncate" style={{ color: c.terminated ? t.inkFaint : "rgba(255,255,255,0.7)" }}>{c.sublabel}</p>
            <div className="flex items-center gap-2">
              <p className="text-[19px] font-bold" style={{ color: c.terminated ? t.ink : "#fff", fontFamily: "'IBM Plex Mono', monospace" }}>
