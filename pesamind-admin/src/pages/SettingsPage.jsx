...
const HELP = {
  ...
  receipt_ocr_enabled: "\"true\" or \"false\" — turns off receipt scanning immediately; customers are directed to add expenses manually. Which OCR provider actually runs (mock vs. real) is set via the OCR_PROVIDER environment variable, not here.",
};
