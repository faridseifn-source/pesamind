...
const emptyForm = {
  ...
  validity: "MONTHLY", price: 0, includedTransactionTypeIds: [],
...
export default function FeeBundlesPage({ user }) {
  ...
  return (
    <div>
      ...
      <p className="text-[13.5px] text-inkFaint mb-6">Daily, weekly, or monthly packages customers can buy for unlimited or discounted eligible transactions.</p>
