  ...
  return (
    <div>
      ...
      <div className="flex items-end gap-2 mb-6">
        ...
        <Button variant="ghost" onClick={downloadCsv} disabled={downloading} className="flex items-center gap-1.5"><Download size={14} /> {downloading ? "Preparing…" : "Download CSV"}</Button>
      </div>
