...
import { Search, X, ShieldAlert, ShieldCheck, FileText, Eye } from "lucide-react";
import { adminApi } from "../api.js";
import { Card, Badge, Button, Input, Spinner, Pagination, EmptyState, fmtTZS } from "../components/ui.jsx";

function UserDetailPanel({ userId, canManage, canViewFinancials, onClose, onChanged }) {
...
export default function UsersPage({ user }) {
  ...
  return (
    <div>
      ...
      {selectedId && (
        <UserDetailPanel userId={selectedId} canManage={canManage} canViewFinancials={canViewFinancials} onClose={() => setSelectedId(null)} onChanged={load} />
      )}
    </div>
  );
}
