...
export const adminApi = {
  ...
  fees: {
    ...
    downloadReportCsv: (from, to) => downloadFile(`/admin/fees/report?${qs({ from, to, format: "csv" })}`, "pesamind-fee-revenue.csv"),
    downloadReportDetailCsv: (from, to) => downloadFile(`/admin/fees/report/detail?${qs({ from, to, format: "csv" })}`, "pesamind-fee-transactions.csv"),
  },
